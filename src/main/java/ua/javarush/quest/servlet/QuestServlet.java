package ua.javarush.quest.servlet;
...
import ua.javarush.quest.logic.QuestLogic;
...
public class QuestServlet extends HttpServlet {
    private QuestLogic questService;
    private String questName;

    @Override
    public void init() {
        try {
            questService = new QuestLogic();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (!isLastQuestion && !isWrongAnswer) {
                List<AdventureAnswer> answersByQuestion = questService.getAnswersByQuestionId(questName, nextQuestionId);
